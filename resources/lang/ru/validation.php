...
return [
    ...
    */
    ...
    'after' => 'Дата в поле :attribute должно быть позже :date.',
    ...
    'digits' => 'Поле :attribute должно содеражть :digits цифры.',
    ...
    'image' => 'В поле :attribute может быть загружен только файл изображения.',
    'in' => 'Поле :attribute некорректно.',
    ...
    'mimetypes' => 'Файл :attribute должен быть в формате: :values.',
    'min' => [
    ...
    */
	...
	'attributes' => [
		...
		'contractor-name' => '"ФИО контрагента"',
		'passport-series' => '"Серия паспорта"',
		'passport-number' => '"Номер паспорта"',
		'passport-date' => '"Дата выдачи паспорта"',
		'passport-office' => '"Кем выдан, код подразделения"',
		'passport-address' => '"Адрес регистрации"',
		'passport-file-1' => '"Первая страница паспорта"',
		'passport-file-2' => '"Вторая страница паспорта"',
	],
